...
class JuruBeliController extends Controller
{
    ...
    public function create_sph()
    {
        $nama_subkon = User::get();
        $dok_sph = DokSph::paginate(10);
        return view('jurubeli.tambah_sph', compact(['dok_sph','nama_subkon']));
    }
    ...
    public function edit_sph($id)
    {
        $dok_sph = DokSph::findOrFail($id);
        $nama_subkon = User::get();
        return view('jurubeli.edit_sph', compact(['dok_sph','nama_subkon']));
    }
    ...
    {
        $dok_sph = DokSph::findOrFail($id);
        return view('jurubeli.upload_sph', compact(['dok_sph']));
    }
