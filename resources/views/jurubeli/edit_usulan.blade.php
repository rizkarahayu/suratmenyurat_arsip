            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        @endif
                    <form class="form-horizontal" method="POST" action="{{ url('/edit_usulan/update/'.$dok_usulan->id) }}" autocomplete="off" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="modal-body">    
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>No Memo </label>
                                <input type="text" class="form-control" name="no_memo" id="no_memo"  value="{{$dok_usulan->no_memo}}" >
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Referensi J01</label>
                                <input type="text" class="form-control" name="referensi_j01" id="referensi_j01"  value="{{$dok_usulan->referensi_j01}}">  
                            </div>
