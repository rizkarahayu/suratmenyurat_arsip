                    ...
                    <form class="form-horizontal" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_surat" id="no_surat" disabled placeholder="{{$dok_spk->no_surat}}">       
                            </div> 
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>No SPH</label>
                                <input class="form-control" name="no_sph" id="no_sph" disabled placeholder="{{$dok_spk->no_sph}}">
                            </div>  
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Tanggal SPH</label>
                                <input class="form-control datepicker" placeholder="{{$dok_spk->tanggal_sph}}" name="tanggal_sph" id="tanggal_sph" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>No BAET</label>
                                <input class="form-control" name="no_baet" id="no_baet" disabled placeholder="{{$dok_spk->no_baet}}">
                            </div>  
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Tanggal BAET</label>
                                <input class="form-control datepicker" placeholder="{{$dok_spk->tanggal_baet}}" name="tanggal_baet" id="tanggal_baet" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>No BANH</label>
                                <input class="form-control" name="no_banh" id="no_banh" disabled placeholder="{{$dok_spk->no_banh}}">
                            </div>  
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Tanggal BANH</label>
                                <input class="form-control datepicker" placeholder="{{$dok_spk->tanggal_banh}}" name="tanggal_banh" id="tanggal_banh" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Nama Proyek</label>
                                <input class="form-control" name="nama_proyek" id="nama_proyek" disabled placeholder="{{$dok_spk->nama_proyek}}">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Harga</label>
                                <input class="form-control" placeholder="{{$dok_spk->harga}}" name="harga" id="harga" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Harga Terbilang</label>
                                <input class="form-control" name="harga_terbilang" id="harga_terbilang" disabled placeholder="{{$dok_spk->harga_terbilang}}">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Tanggal Mulai</label>
                                <input class="form-control datepicker" placeholder="{{$dok_spk->tanggal_mulai}}" name="tanggal_mulai" id="tanggal_mulai" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Tanggal Selesai</label>
                                <input class="form-control datepicker" placeholder="{{$dok_spk->tanggal_selesai}}" name="tanggal_selesai" id="tanggal_selesai" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Tanggal Dibuat</label>
                                <input class="form-control datepicker" placeholder="{{$dok_spk->tanggal_dibuat}}" name="tanggal_dibuat" id="tanggal_dibuat" type="text">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="{{$dok_spk->tembusan2}}" name="tembusan2" id="tembusan2" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Tembusan3</label>
                                <input class="form-control" placeholder="{{$dok_spk->tembusan3}}" name="tembusan3" id="tembusan3" type="text">
                            </div>
