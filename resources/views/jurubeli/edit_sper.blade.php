            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        @endif
                    <form class="form-horizontal" method="POST" action="{{ url('/edit_sper/update/'.$dok_sper->id) }}" autocomplete="off" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="modal-body">    
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>No SPER </label>
                                <input type="text" class="form-control" name="no_sper" id="no_sper"  value="{{$dok_sper->no_sper}}" >
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Referensi J01</label>
                                <input type="text" class="form-control" name="referensi_j01" id="referensi_j01"  value="{{$dok_sper->referensi_j01}}">  
                            </div>
