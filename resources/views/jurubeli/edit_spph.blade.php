                ...
                <div class="box">
                    <div class="box-header">
                        <div class="card-header text-center">
                            Edit Dokumen SPPH : {{$dok_spph->no_surat}}
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        @endif
                    <form class="form-horizontal" method="POST" action="{{ url('/edit_spph/update/'.$dok_spph->id) }}" autocomplete="off" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Nomor Surat</label>
                                <input type="text" class="form-control" name="no_surat" id="no_surat" value="{{$dok_spph->no_surat}}">       
                            </div> 
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Perihal</label>
                                <input type="text" class="form-control" name="perihal" id="perihal" value="{{$dok_spph->perihal}}">  
                            </div>
                            <div class="form-group">
                                ...
                                <select  class="form-control" name ="nama_subkon" id="nama_subkon">
                                    <option value="{{ $dok_spph->nama_subkon }}" >{{ $dok_spph->nama_subkon }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datepicker" name="tanggal_dibuat" id="tanggal_dibuat" type="datetime" value="{{$dok_spph->tanggal_dibuat}}">
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Deskripsi Pekerjaan Jasa</label>
                                <input type="textarea" class="form-control" name="deskripsi_jasa" id="deskripsi_jasa" value="{{$dok_spph->deskripsi_jasa}}">
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="jam" id="jam" value="{{$dok_spph->jam}}">
                            </div> 
