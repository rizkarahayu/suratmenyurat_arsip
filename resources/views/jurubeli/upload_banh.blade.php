                        ...
                        <form action="{{ url('/dok_banh/uploadstore_banh/'.$dok_banh->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Masukkan File BANH</label>
                                        <input type="file" class="form-control" name="file_banh" id="file_banh" required placeholder="Pilih File Untuk BANH">       
                                    </div> 
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Keterangan BANH</label>
                                        <input type="text" class="form-control" name="keterangan_banh" id="keterangan_banh" required placeholder="Masukkan Keterangan Untuk BANH">  
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="modal-body">
                            <div class="card card-default">
                                <div class="card-header">
                                    <h4 class="card-title">File Upload Dokumen BANH & Estimasi Index Kewajaran Harga</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                            <td>
                                                <a href="{{asset('/uploads/banh/'.$dok_banh->file_banh)}}">{{$dok_banh->file_banh}}</a>
                                            </td>
