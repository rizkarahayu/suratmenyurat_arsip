                    ...
                    <form class="form-horizontal" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kodej01" id="kodej01" required placeholder="{{$surat_masuk_kadep->kodej01}}" >       
                            </div> 
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Kode Proyek</label>
                                <input type="text" class="form-control" name="kode_proyek" id="kode_proyek" required placeholder="{{$surat_masuk_kadep->kode_proyek}}" >
                            </div> 
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Deskripsi Pekerjaan Jasa</label>
                                <input type="text" class="form-control" name="deskripsi" id="deskripsi" required placeholder="{{$surat_masuk_kadep->deskripsi}}" >
                            </div> 
                            <div class="form-group">
                            ...
                            @elseif($surat_masuk_kadep->status_surat == 'ditolak')
                                <input class="form-control" placeholder="Ditolak" name="status_surat" id="status_surat" type="text">
                            @else
                                <input class="form-control" placeholder="Belum Verifikasi" name="status_surat" id="status_surat" type="text">
                            @endif
                            </div> 
