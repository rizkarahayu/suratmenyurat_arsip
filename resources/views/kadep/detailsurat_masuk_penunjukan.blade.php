                    ...
                    <form class="form-horizontal" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kodej01" id="kodej01" placeholder="{{$surat_masuk_kadep->kodej01}}" >       
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-tty"> &nbsp;</i>Kode Proyek</label>
                                                <input type="text" class="form-control" name="kode_proyek" id="kode_proyek" placeholder="{{$surat_masuk_kadep->kode_proyek}}" >
                                            </div> 
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-12 control-label"><i class="fa fa-tty"> &nbsp;</i>Deskripsi Pekerjaan Jasa</label>
                                                <input type="text" class="form-control" name="deskripsi" id="deskripsi" placeholder="{{$surat_masuk_kadep->deskripsi}}" >
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-6 control-label"><i class="fa fa-tty"> &nbsp;</i>Nama Kabiro</label>
                                                <input class="form-control" placeholder="{{$surat_masuk_kadep->nama_pj}}" name="nama_pj" id="nama_pj" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-6 control-label"><i class="fa fa-tty"> &nbsp;</i>Jenis Pengadaan</label>
                                                <input class="form-control" placeholder="{{$surat_masuk_kadep->jenis_pengadaan}}" name="status_surat" id="status_surat" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-6 control-label"><i class="fa fa-tty"> &nbsp;</i>Tanggal Diterima</label>
                                                <input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_diterima}}" name="tanggal_diterima" id="tanggal_diterima" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="modal-body">
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row border">
                                        ...
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_mulai_spph}}" name="tanggal_mulai_spph" id="tanggal_mulai_spph" type="text"></div>
                                        <div class="col-sm-3"> <input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_selesaispph}}" name="tanggal_selesaispph" id="tanggal_selesaispph" type="text"></div>
                                    </div>
                                    <div class="row border">
                                        <div class="col-sm-1">2</div>
                                        <div class="col-sm-5">Pembukaan Dokumen Penawaran</div>
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_mulai_dokpenawaran}}" name="tanggal_mulai_dokpenawaran" id="tanggal_mulai_dokpenawaran" type="text"></div>
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_selesai_dokpenawaran}}" name="tanggal_selesai_dokpenawaran" id="tanggal_selesai_dokpenawaran" type="text"></div>
                                    </div>
                                    <div class="row border">
                                        <div class="col-sm-1">3</div>
                                        <div class="col-sm-5">Evaluasi Teknik (BAET)</div>
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_mulai_baet}}" name="tanggal_mulai_baet" id="tanggal_mulai_baet" type="text"></div>
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_selesai_baet}}" name="tanggal_selesai_baet" id="tanggal_selesai_baet" type="text"></div>
                                    </div>
                                    <div class="row border">
                                        <div class="col-sm-1">4</div>
                                        <div class="col-sm-5">Negoisasi (BANH)</div>
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_mulai_banh}}" name="tanggal_mulai_banh" id="tanggal_mulai_banh" type="text"></div>
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kadep->tanggal_selesai_banh}}" name="tanggal_selesai_banh" id="tanggal_selesai_banh" type="text"></div>
                                    </div>
                                    <div class="row border">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="{{$surat_masuk_kadep->status_surat_kabiro}}" type="input">
                            </div>
                            </div>
                        </div>
