                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row border">
                                        ...
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kabiro->tanggal_mulai_pemenang}}" name="tanggal_mulai_banh" id="tanggal_mulai_pemenang" type="text"></div>
                                        <div class="col-sm-3"><input class="form-control" placeholder="{{$surat_masuk_kabiro->tanggal_selesai_pemenang}}" name="tanggal_selesai_banh" id="tanggal_selesai_pemenang" type="text"></div>
                                    </div>
                                    <div class="row border">
