            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        @endif
                    <form class="form-horizontal" method="POST" action="{{ url('/surat_masuk_kabiro/update_pemlihan_langsung/'.$surat_masuk_kabiro->id) }}" autocomplete="off" enctype="multipart/form-data">
                            {{ csrf_field() }}
